...
-- 5. Migrate existing profile tiers to user_roles
...
CREATE POLICY "Anyone can view public poker table info"
ON public.poker_tables_public
FOR SELECT
USING (true);
...
-- 11. Remove tier column from profiles (deprecated)
-- Note: Keeping it for now to avoid breaking existing code, will remove in future migration
